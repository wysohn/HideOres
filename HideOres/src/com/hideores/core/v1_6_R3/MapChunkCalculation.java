package com.hideores.core.v1_6_R3;
...
public class MapChunkCalculation implements IMapChunkCalculation{
	public static void calcAndChange(World world, Packet51MapChunk packet){
		int x = packet.c;
		int z = packet.d;
		
		//get uncompressedData from packet
		byte[] unCompressedData = (byte[]) ReflectionHelper.getPrivateField(packet, "inflatedBuffer");
	...
	public static void calcAndChange(World world, Packet56MapChunkBulk packet){
		int[] xArray = (int[]) ReflectionHelper.getPrivateField(packet, "c");
		int[] zArray = (int[]) ReflectionHelper.getPrivateField(packet, "d");
